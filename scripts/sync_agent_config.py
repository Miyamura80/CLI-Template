...
# ///
"""Sync Claude <-> Codex skills, subagents, and AGENTS.md mirrors.
...
# loop through the skill symlinks it just created.
AGENTS_MD_SKIP_DIRS = {
    "node_modules",
    "venv",
    ".venv",
...
def main() -> int:
    ...
    changes = sync_skill_symlinks() + sync_agents() + sync_agents_md_symlinks()
    for c in changes:
        print(c)
